// DEFINING A TUPLE
// Tuple is an array = 3d coordinate x,y,z: each item in tuple can be any type you want
...
// in REACT useState return a tuple

// implement something similar to useState that return a tuple
